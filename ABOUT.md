...
![HELM command surface](docs/assets/hero/helm-hero-01-command-surface.jpg)
...
![Use-case matrix from the matching rules](docs/assets/diagrams/use-case-matrix.svg)
...
![The HELM pipeline from data to gate](docs/assets/hero/helm-hero-03-pipeline.jpg)
...
![The starter register rendered in six languages](docs/assets/helm-restyle-six-languages.jpg)
...
![HELM in an operations setting](docs/assets/hero/helm-hero-04-operations-room.jpg)
...
![Implementation flow in Claude Code](docs/assets/diagrams/implementation-flow.svg)
...
![Anatomy of a HELM screen](docs/assets/diagrams/screen-anatomy.svg)
...
![The HELM engine and its five facets](docs/assets/hero/helm-hero-05-engine-map.jpg)
...
HELM is part of the BHIL framework family, alongside CADRE (the agent pattern it runs on), QUADRA, CIPHER, PRIMER, LOCUS, and FACET (which shares its evidence-tier vocabulary). Version history is in the [changelog](CHANGELOG.md).
